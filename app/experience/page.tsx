...
export const metadata = {
  title: "Experience",
  description:
    "Professional experience of Krishna Kumar, including work across healthcare, compliance, sports technology, and robotics platforms.",

  openGraph: {
    title: "Experience | Krishna Kumar",
    description:
      "Professional experience of Krishna Kumar, including work across healthcare, compliance, sports technology, and robotics platforms.",
    type: "profile",
    locale: "en_IN",
