...
const BASE_PATH = "/apps/smart2048";
const SUPPORT_EMAIL = "support@smart2048.app";
const LAST_UPDATED = "June 6, 2026";

export const metadata = {
  title: "2048 Terms & Conditions",
  description:
    "Terms and conditions for 2048, a classic puzzle game by Smart2048 / IKIGAI APPLICATIONS.",
  openGraph: {
    title: "2048 Terms & Conditions",
    description:
      "Terms and conditions for 2048, a classic puzzle game by Smart2048 / IKIGAI APPLICATIONS.",
...
export default function Smart2048TermsPage() {
  return (
    <>
      <PageHeader
        title="2048 Terms & Conditions"
      ...
      <Section title="Agreement">
        <p>
          These Terms & Conditions (&quot;Terms&quot;) govern your use of the 2048 mobile
          application (the &quot;App&quot;) provided by Smart2048 (&quot;we&quot;, &quot;us&quot;, or
          &quot;our&quot;).
        </p>
        <p>
      ...
      <Section title="Game Content">
        <p>
          The 2048 puzzle game mechanics are based on a widely known open game concept.
          Our App includes original implementation, design, and features.
        </p>
        <p>
          Game scores, progress, and settings are stored locally on your device and may
      ...
      <Section title="Advertising">
        <p>
          The App is supported by advertising. Third-party ad networks may display ads
          within the App. Your interaction with ads is subject to the ad provider&apos;s
          terms and policies.
        </p>
        <p>
      ...
      <Section title="Acceptable Use">
        <p>
          ...
          gameplay, or use the App for any unlawful purpose.
        </p>
      </Section>
      ...
      <Section title="Intellectual Property">
        <p>
          The App, including its code, graphics, and branding (excluding third-party
          components and the general 2048 game concept), is owned by us or our
