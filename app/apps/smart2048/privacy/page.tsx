...
export const metadata = {
  title: "2048 Privacy Policy",
  description:
    "Privacy policy for 2048, a classic puzzle game by Smart2048 / IKIGAI APPLICATIONS.",
  openGraph: {
    title: "2048 Privacy Policy",
    description:
      "Privacy policy for 2048, a classic puzzle game by Smart2048 / IKIGAI APPLICATIONS.",
...
export default function Smart2048PrivacyPage() {
  return (
    <>
      <PageHeader
        title="2048 Privacy Policy"
      ...
      <Section title="Overview">
        <p>
          This Privacy Policy describes how Smart2048 (&quot;we&quot;, &quot;us&quot;, or
          &quot;our&quot;) collects, uses, and shares information when you use the 2048
      ...
      <Section title="Information We Collect">
        ...
        <p>
          <strong>Locally stored data:</strong> Your best score, game settings (such
          as haptic feedback preferences), and similar gameplay data are stored on
          your device using local storage. This data is not transmitted to our
          servers.
        </p>
        <p>
          <strong>Advertising data:</strong> The App displays advertisements provided
          by Google AdMob. AdMob and its partners may collect device identifiers, IP
          address, ad interaction data, and similar information to deliver and measure
          ads. See{" "}
          <a
      ...
      <Section title="How We Use Information">
        <p>
          ...
          remembering your high score and preferences.
        </p>
        <p>
